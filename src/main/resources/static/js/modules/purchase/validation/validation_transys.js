...
function parseCarrierBarcode(barcode) {
	...
	const itemcode = parts[2].substring(1);   // P89900XG100WK → 89900XG100WK
	const qty      = parts[3].substring(2);   // 5Q15 → 15
...
function showCarrierInfo(info) {
	...
	$('#nowqty').text(info.qty);
	$('#targetQty').text(info.qty);
